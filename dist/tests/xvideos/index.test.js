...
const index_1 = __importDefault(require("../../src/service/xvideos/index"));
...
describe('XvideosSearch', () => {
    ...
    let html;
    beforeEach(() => {
        xvideosService = new index_1.default();
        html = fs_1.default.readFileSync('tests/mocks/xvideos.html', 'utf-8');
    ...
    test('search should scrape the videos', () => __awaiter(void 0, void 0, void 0, function* () {
        const videos = yield xvideosService.search('elisa-sanches');
